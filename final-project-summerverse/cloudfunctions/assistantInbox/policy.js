...
function draft(value) {
  ...
  requireValue(['memory', 'goal'].includes(value.kind));
...
function publicConnection(c) {
  return { id: c.publicId, name: c.name, readRecent: c.readRecent, workJobs: c.workJobs === true, expiresAt: c.expiresAt, lastUsedAt: c.lastUsedAt || null, revoked: !!c.revoked };
}
